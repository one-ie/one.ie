...
dimension: groups
category: vision.md
tags: agent, ai, connections, events, knowledge, people, protocol, things
...
version: 1.0.0
ai_context: |
  This document is part of the groups dimension in the vision.md category.
  Location: one/groups/vision.md
  Purpose: Documents vision: build ai agents, applications, and your audience
  Related dimensions: connections, events, knowledge, people, things
  For AI agents: Read this to understand vision.
---
