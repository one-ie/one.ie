...
import { createInstallationFolder, mirrorOntologyStructure, createOnboardingFile, updateOrgEnvFile, updateGitignore, rollbackInstallation, } from "../utils/installation-setup.js";
import { isValidEmail, isValidUrl, slugify, isReservedName, isReservedWebsite, } from "../utils/validation.js";
    ...
    if (enhanceWebsite) {
        ...
        if (await fs.pathExists(webPath)) {
            ...
            try {
                ...
                await execAsync(`git clone --depth 1 https://github.com/one-ie/web.git "${webPath}"`);
...
`;
    ...
    try {
        ...
        installationPath = await createInstallationFolder(installationName, basePath);
