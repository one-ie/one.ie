 ...
 */
export async function detectUserIdentity() {
 ...
 */
export async function detectOrganization(basePath = process.cwd()) {
 ...
 */
export async function detectWebsite(basePath = process.cwd()) {
    // 1. Check CLI flag
 ...
 */
export async function detectProjectName(basePath = process.cwd()) {
 ...
 */
export async function detectContext(basePath = process.cwd()) {
