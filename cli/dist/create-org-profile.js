...
export async function createOrgProfile(profile) {
    const filePath = path.join(process.cwd(), `one/organisation/${profile.slug}.md`);
    // Create directory
...
//# sourceMappingURL=create-org-profile.js.map