...
// Valid status values
const VALID_STATUSES = ["planned", "in_development", "beta", "completed", "deprecated"];
...
describe("Feature Schema Validation", () => {
  ...
  describe("Valid Enum Values", () => {
    ...
    it("should validate person role enum", () => {
      const validPersonRoles = ["platform_owner", "org_owner", "org_user", "customer"];
  ...
  describe("Array Field Validation", () => {
    ...
    it("should validate relatedFeatures array", () => {
      const related: FeatureSchema["relatedFeatures"] = ["auth", "user-management"];
  ...
  describe("Object Structure Validation", () => {
    it("should validate marketingPosition object", () => {
      ...
      expect(["free", "starter", "pro", "enterprise"]).toContain(mp.pricingImpact);
    });
  ...
  describe("Ontology Dimensions", () => {
    it("should accept all 6 ontology dimensions", () => {
      const dimensions = ["groups", "people", "things", "connections", "events", "knowledge"];
