				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					<div className="group relative overflow-hidden rounded-lg border bg-card p-6 hover:shadow-lg transition-shadow">
						<div className="flex flex-col space-y-4">
							...
							<p className="text-muted-foreground">
								Built on a 6-dimension ontology that models reality through
								Groups, People, Things, Connections, Events, and Knowledge.
							</p>
						</div>
					</div>
					...
					<div className="group relative overflow-hidden rounded-lg border bg-card p-6 hover:shadow-lg transition-shadow">
						<div className="flex flex-col space-y-4">
							...
							<p className="text-muted-foreground">
								Hierarchical groups from friend circles to global governments.
								Complete data isolation with flexible access control.
							</p>
						</div>
					</div>
					...
					<div className="group relative overflow-hidden rounded-lg border bg-card p-6 hover:shadow-lg transition-shadow">
						<div className="flex flex-col space-y-4">
							...
							<p className="text-muted-foreground">
								Powered by Convex for instant updates. Effect.ts for pure
								business logic. Type-safe from database to UI.
							</p>
						</div>
					</div>
				</div>
