...
export const categoryColors = {
	"ai-integration": {
		light: {
			background: "280 65% 85%",
			foreground: "280 65% 20%",
			border: "280 65% 45%",
		},
		dark: {
			background: "280 65% 35%",
			foreground: "280 65% 90%",
			border: "280 65% 50%",
		},
	},
	authentication: {
		light: {
			background: "220 65% 85%",
			foreground: "220 65% 20%",
			border: "220 65% 45%",
		},
		dark: {
			background: "220 65% 35%",
			foreground: "220 65% 90%",
			border: "220 65% 50%",
		},
	},
	"content-management": {
	...
	analytics: {
		light: {
			background: "260 70% 85%",
			foreground: "260 70% 20%",
			border: "260 70% 45%",
		},
		dark: {
			background: "260 70% 35%",
			foreground: "260 70% 90%",
			border: "260 70% 50%",
		},
	},
	performance: {
		light: {
			background: "142 70% 85%",
			foreground: "142 70% 20%",
			border: "142 70% 45%",
		},
		dark: {
			background: "142 70% 35%",
			foreground: "142 70% 90%",
			border: "142 70% 50%",
		},
	},
	...
	database: {
		light: {
			background: "270 65% 85%",
			foreground: "270 65% 20%",
			border: "270 65% 45%",
		},
		dark: {
			background: "270 65% 35%",
			foreground: "270 65% 90%",
			border: "270 65% 50%",
		},
	},
	deployment: {
	...
	integration: {
		light: {
			background: "190 70% 85%",
			foreground: "190 70% 20%",
			border: "190 70% 45%",
		},
		dark: {
			background: "190 70% 35%",
	...
	"developer-tools": {
		light: {
			background: "210 90% 85%",
			foreground: "210 90% 20%",
			border: "210 90% 45%",
		},
		dark: {
			background: "210 90% 35%",
	...
	infrastructure: {
		light: {
			background: "315 65% 85%",
			foreground: "315 65% 20%",
			border: "315 65% 45%",
		},
		dark: {
			background: "315 65% 35%",
			foreground: "315 65% 90%",
			border: "315 65% 50%",
		},
	},
} as const;
