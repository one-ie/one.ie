			...
			<Card className="relative overflow-hidden">
				...
				<CardContent>
					<Tabs defaultValue="vision" className="space-y-4">
						...
						>
							<p>
								Drop ONE components onto any page and let agents adapt copy,
								imagery, and data without breaking design.
							</p>
						...
						>
							<p>
								Recharts, cards, and badges sync with live data sources through
								our providers. Zero bespoke wiring needed.
							</p>
						</TabsContent>
						<TabsContent
							value="handoff"
			...
			<Card className="xl:col-span-1">
				...
				<CardContent className="space-y-4">
					...
					<div className="rounded-2xl border border-dashed border-primary/40 bg-primary/5 p-4 text-sm text-muted-foreground">
						...
						Agents stream component changes, humans review in context, and
						stakeholders approve on the spot.
					</div>
				</CardContent>
			</Card>
		</div>
