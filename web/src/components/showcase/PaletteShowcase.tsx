		...
		<div className="grid gap-6 lg:grid-cols-[1fr_1fr]">
			<Card className="relative overflow-hidden">
				<CardHeader className="space-y-2">
					...
					<CardDescription>
						Polished actions aligned with the ONE design language—drop them into
						any flow.
					</CardDescription>
				</CardHeader>
				...
				<CardContent className="space-y-4">
					...
					<div className="flex items-center gap-3 rounded-2xl border border-dashed border-primary/40 bg-primary/5 p-4">
						...
						<div>
							...
							<p className="text-xs text-muted-foreground">
								Works with dark mode, gradient backgrounds, and glassmorphism
								out of the box.
							</p>
						</div>
					</div>
				...
				<CardContent>
					<Tabs defaultValue="status" className="space-y-6">
						...
						>
							...
							<p>
								• 09:31 — Leon connected dashboard metrics to live Convex data.
							</p>
