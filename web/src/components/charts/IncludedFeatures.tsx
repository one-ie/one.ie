        ...
        <CardContent className="relative space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-4">
              <h4 className="font-bold text-lg mb-4 text-primary">What You Get</h4>
            ...
            {/* Right Column */}
            <div className="space-y-4">
              <h4 className="font-bold text-lg mb-4 text-purple-600">Plus More</h4>
          ...
          <div className="rounded-2xl border-2 border-green-500/40 bg-gradient-to-br from-green-500/15 via-emerald-500/5 to-transparent p-8 space-y-4 shadow-xl shadow-green-500/20">
            <p className="text-base text-muted-foreground font-medium">Typical Monthly Value</p>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  <span className="text-base font-medium">{item.platform} comparable plan</span>
          ...
          <div className="rounded-2xl bg-gradient-to-r from-primary/10 via-purple-500/5 to-primary/10 border-2 border-primary/30 p-8 text-center space-y-3 shadow-xl">
            <p className="text-base text-muted-foreground font-medium">Annual Savings</p>
