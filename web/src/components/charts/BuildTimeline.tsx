          ...
          <div className="rounded-xl border border-border/50 bg-black/90 p-4 font-mono text-xs space-y-1 h-32 overflow-hidden">
            ...
            {currentStep >= 0 && (
              <>
                ...
                <div className="text-cyan-400">▶ {buildSteps[currentStep]?.name}...</div>
      ...
      {showDetails && (
        <Card className="border-2 border-border/50 bg-card/50 backdrop-blur-xl">
          <CardHeader>
            ...
            <CardDescription>How our build process compares to traditional tools</CardDescription>
          </CardHeader>
          <CardContent>
