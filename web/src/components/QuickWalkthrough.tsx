				...
				<CardContent className="pt-6">
					<div className="flex items-center gap-3">
						...
						<p className="text-sm text-green-900 dark:text-green-100">
							After these 5 steps, you'll have a fully functional application
							with type-safe content, beautiful components, and the ontology
							foundation to scale to enterprise complexity.
						</p>
					</div>
				</CardContent>
			</Card>
