...
describe("VideoPlayer", () => {
  it("renders YouTube embed for YouTube URLs", () => {
    const { container } = render(<VideoPlayer src="https://www.youtube.com/watch?v=dQw4w9WgXcQ" />);
  ...
  it("renders audio player for audio files", () => {
    const { container } = render(<VideoPlayer src="https://example.com/audio.mp3" type="audio" />);
