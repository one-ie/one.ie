  ...
  const steps = [
    {
      ...
      description:
        "Build the essential strategic bedrock using the Ebook & worksheets to define your Company Context, Market Awareness, and Ideal Customer Avatar. This rich data fuels the prompt system.",
    ...
    },
    {
      ...
      description:
        "Generate assets with AI, implement your strategy, and improve with community support. Get feedback, share insights, and stay updated with the latest AI marketing trends.",
