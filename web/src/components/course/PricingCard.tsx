...
export function PricingCard({
	...
	return (
		<Card
			className={`overflow-hidden border-2 ${popular ? "border-primary" : "border-border"} ${className}`}
		>
			{popular && (
			...
			<div className="p-6">
				...
				<Button size="lg" className="w-full mb-6" onClick={onClickCta}>
				...
				<div className="flex items-center justify-center gap-2 text-sm mb-6">
					...
					<span>
						{guaranteeDays}-Day {guaranteeText}
					</span>
				</div>
