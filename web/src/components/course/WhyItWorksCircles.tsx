      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-xl text-muted-foreground">
            Let's break down why our framework delivers superior results compared to standalone,
            "simple" AI prompting
          </p>
        </div>
        ...
        {/* Blueprint Analogy */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-center mb-8">The Blueprint Analogy</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-6 border-red-100 bg-red-50/10 dark:bg-red-950/5">
              ...
              <p className="text-muted-foreground">
                Giving someone a powerful hammer but no blueprints, no specific nails, and no
                instructions – they might eventually build something, but it will be slow,
                inefficient, and likely unstable.
              </p>
            </Card>
            ...
            <Card className="p-6 border-green-100 bg-green-50/10 dark:bg-green-950/5">
              ...
              <p className="text-muted-foreground">
                Providing detailed blueprints (the Framework), specialized power tools with precise
                settings (the Prompts), fueled by the right materials (your Foundation data).
              </p>
            </Card>
          </div>
        </div>
