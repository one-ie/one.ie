			...
			<div className="container mx-auto px-4">
				<div className="text-center max-w-3xl mx-auto mb-16">
					...
					<p className="text-lg text-muted-foreground">
						This Course Isn't Just About AI Prompts – It's About Systematically
						Implementing Them Within a Proven Growth Framework
					</p>
				</div>
				...
				<div className="text-center">
					...
					<p className="mt-4 text-sm text-muted-foreground">
						Join successful store owners implementing the complete AI-powered
						Elevate System
					</p>
				</div>
			</div>
