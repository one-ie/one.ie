        ...
        <Card className="max-w-4xl mx-auto p-8 md:p-12 border-primary/20">
          ...
          <div className="space-y-6 mb-12">
            <h3 className="text-2xl font-semibold">
              Work 1:1 via private video coaching sessions to:
            </h3>
              ...
              {[
                {
                  ...
                  description:
                    "Apply Foundation principles with surgical precision to your specific customers, products, market position, and biggest growth bottlenecks.",
                },
                {
                  icon: FileCheck,
                  title: "Custom-Build YOUR Framework Strategy",
                  description:
                    "Map the 9 steps (Hook to Share) directly onto your business objectives for immediate relevance.",
                },
                {
                  icon: Star,
                  title: "Deploy High-Impact AI Prompts TOGETHER",
                  description:
                    "Get personal guidance using the most crucial Playbook prompts to generate initial, high-performance assets tailored for you.",
                },
                {
                  icon: CheckCircle2,
                  title: "Forge YOUR AI Growth Blueprint",
                  description:
                    "Leave with the core structure already implemented and a clear, actionable roadmap designed by the system's creator.",
                },
              ].map((item, i) => (
          ...
          <div className="space-y-8 mb-12">
            <h3 className="text-2xl font-semibold text-center">
              What You Secure Today for $1,499:
            </h3>
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Full access to all modules, complete prompt library, and future updates (June 1, 2025 launch).",
                },
                {
                  value: "Priceless",
                  title: "Your Bespoke AI System Blueprint",
                  description:
                    "A documented, personalized strategy and action plan crafted during our sessions.",
                },
                {
                  value: "Exclusive",
          ...
          <div className="text-center space-y-6">
            ...
            <div className="max-w-lg mx-auto">
              <a
                href="/pay-coaching"
                className="block p-[1px] bg-white shadow-[0_0_30px_rgba(0,0,0,0.8)] hover:shadow-[0_0_50px_rgba(0,0,0,0.9)] transition-all duration-300"
              >
                <Button
                  size="lg"
                  className="w-full text-lg h-14 bg-[#1E3A8A] hover:bg-black text-white border border-white hover:border-white rounded-none transform hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden group"
                >
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                ...
                <li className="flex items-start gap-2">
                  ...
                  Get full course access on June 1, 2025
                </li>
              </ul>
            </div>
