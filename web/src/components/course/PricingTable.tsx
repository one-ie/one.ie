						...
						<div className="flex items-center gap-3 mb-6">
							...
							<div>
								...
								<p className="text-sm text-muted-foreground">
									If you implement the strategies taught in the first two
									modules and don't see measurable improvements within{" "}
									{guaranteeDays} days, we'll refund your entire investment.
								</p>
							</div>
						</div>
					</div>
