		...
		<div className="space-y-6">
			...
			<div className="text-center space-y-3">
				...
				<p className="text-muted-foreground max-w-2xl mx-auto">
					Upgrade to unlock powerful features like reasoning visualization, tool
					integration, persistent chat history, and more.
				</p>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				...
				<Card className="border-2 hover:border-primary/50 transition-colors">
					<CardHeader>
						...
						<CardDescription className="text-sm">
							AI can use external tools, APIs, and data sources to enhance
							responses
						</CardDescription>
					</CardHeader>
				</Card>
				...
				<Card className="border-2 hover:border-primary/50 transition-colors">
					<CardHeader>
						...
						<CardDescription className="text-sm">
							All conversations saved automatically and accessible across
							devices
						</CardDescription>
					</CardHeader>
				</Card>
					...
					<Tabs defaultValue="reasoning" className="w-full">
						...
						<TabsContent value="tools" className="space-y-4">
							<div className="space-y-2">
								...
								<p className="text-sm text-muted-foreground">
									The AI can search documentation and provide context-aware
									answers
								</p>
							</div>
