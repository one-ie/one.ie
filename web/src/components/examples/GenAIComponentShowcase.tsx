		...
		<div className="space-y-8">
			<div className="text-center space-y-3">
				...
				<p className="text-muted-foreground max-w-2xl mx-auto">
					All available AI components for building intelligent chat interfaces
				...
				<TabsContent value="basic" className="space-y-6 mt-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Individual message bubble for user and assistant messages with
								timestamps
							</CardDescription>
						</CardHeader>
				...
				<TabsContent value="premium" className="space-y-6 mt-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Visualize AI's step-by-step thinking process with completion
								status
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-4">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Display function/tool calls made by the AI with arguments and
								results
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-4">
					...
					<Card>
						...
						<CardContent className="space-y-4">
							...
							<div className="text-xs text-muted-foreground">
								This demo combines MessageList and PromptInput to create a
