...
const DEMO_MESSAGES = [
  ...
  },
  {
    ...
    content: 'Async/await is syntactic sugar built on top of Promises that makes asynchronous code look and behave more like synchronous code. Here\'s how it works...',
...
const DEMO_TOOL_CALL = {
  ...
  result: {
    results: [
      ...
      { title: 'Cleanup Function', url: 'https://react.dev/learn/synchronizing-with-effects#cleanup' },
    ],
  },
        ...
        <TabsContent value="basic" className="space-y-6 mt-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Animated loading indicator for AI thinking state
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <ul className="text-sm space-y-1 text-muted-foreground">
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">Message</code> - Individual message bubble</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">MessageList</code> - Scrollable message container</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">PromptInput</code> - Auto-expanding input field</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">Suggestions</code> - Clickable prompt suggestions</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">CodeBlock</code> - Syntax-highlighted code</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">LoadingIndicator</code> - Animated loading state</li>
              </ul>
            </div>
            <div className="space-y-2">
              <h4 className="font-semibold text-sm">Premium Components</h4>
              <ul className="text-sm space-y-1 text-muted-foreground">
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">Reasoning</code> - AI thinking visualization</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">ToolCall</code> - Function call display</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">AgentMessage</code> - Multi-type agent message</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">Chatbot</code> - Complete chat interface</li>
                <li>• <code className="text-xs bg-muted px-1 py-0.5 rounded">SimpleChatClient</code> - Full chat client</li>
              </ul>
            </div>
          </div>
        </CardContent>
