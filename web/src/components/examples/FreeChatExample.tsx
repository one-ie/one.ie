...
export function FreeChatExample() {
	...
	// Save to secure storage when key or model changes
					...
					<CardContent className="space-y-4">
						...
						<Alert>
							<AlertDescription className="text-xs">
								🔒 <strong>Security:</strong> Your API key is stored in your
								browser's localStorage (not on our servers). Only use this on
								trusted devices.
	...
	return (
		<div className="container max-w-4xl mx-auto p-6">
						...
						<div className="flex flex-col items-center justify-center h-full text-center space-y-6 p-8">
							<div className="space-y-3">
								...
								<p className="text-muted-foreground max-w-md">
									Try asking me anything! I can help with coding, writing,
			...
			<div className="mt-4 text-xs text-muted-foreground text-center">
				Messages are ephemeral (lost on refresh). Using OpenRouter with your API
				key.
			</div>
