...
export function WorkspaceForm({
	...
	const { check: checkSlug, loading: checkingSlug } =
		useCheckWorkspaceSlugAvailable();
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		if (slugStatus !== "available") {
			setErrors({
				...errors,
				slug:
					slugStatus === "taken" ? "Slug already taken" : "Please check slug",
			});
			return;
		}
		...
		<form onSubmit={handleSubmit} className="space-y-6">
			...
			<Alert>
				...
				<AlertDescription className="text-sm">
					Your workspace URL is how others will access your workspace. Choose
					something memorable and relevant.
				</AlertDescription>
			</Alert>
