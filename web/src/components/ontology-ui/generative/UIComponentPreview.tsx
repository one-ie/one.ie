...
import { Check, Code, Copy, Eye, Monitor, Settings, Smartphone, Tablet } from "lucide-react";
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" onClick={handleCopyCode} disabled={copied}>
              {copied ? (
                <>
            ...
            <div className="flex-1 flex items-center justify-center bg-muted/30 rounded-lg p-4 overflow-auto">
              ...
              >
                {isolation === "iframe" ? (
                  ...
                  <div className="p-4" dangerouslySetInnerHTML={{ __html: componentCode }} />
                )}
              </div>
            </div>
          </TabsContent>
