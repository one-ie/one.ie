        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          {sortable && (
            <div className="flex gap-2">
              ...
              >
                Label{" "}
                {sortConfig?.field === "label" && (sortConfig.direction === "asc" ? "↑" : "↓")}
              </Button>
              <Button
                variant={sortConfig?.field === "category" ? "default" : "outline"}
                size="sm"
              ...
              <Button
                variant={sortConfig?.field === "confidence" ? "default" : "outline"}
                size="sm"
                onClick={() => setSort("confidence")}
              >
                Confidence{" "}
                {sortConfig?.field === "confidence" && (sortConfig.direction === "asc" ? "↑" : "↓")}
              </Button>
            </div>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {displayData.length === 0 ? (
            <div className="col-span-full text-center py-12 text-muted-foreground">
              ...
              {query && <p className="text-sm mt-2">Try adjusting your search terms</p>}
            </div>
          ) : (
