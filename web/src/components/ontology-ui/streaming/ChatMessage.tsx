...
export function ChatMessage({
  ...
  const renderContent = () => {
    if (message.isDeleted) {
      return <div className="italic text-muted-foreground">This message was deleted</div>;
    }
  ...
  return (
    <motion.div
      ...
      className={cn("group flex gap-3 px-4 py-2 hover:bg-muted/50 transition-colors", className)}
          ...
          {isOwnMessage && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {onEdit && <DropdownMenuItem onClick={() => {}}>Edit message</DropdownMenuItem>}
                {onDelete && (
