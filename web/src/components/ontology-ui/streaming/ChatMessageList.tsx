...
export function ChatMessageList({
  ...
  return (
    <div className={`flex flex-col overflow-y-auto space-y-4 p-4 ${className}`} style={{ height }}>
      {hasMore && onLoadMore && (
        <button onClick={onLoadMore} className="text-sm text-blue-600 hover:underline mb-4">
          Load more messages
        </button>
      )}
