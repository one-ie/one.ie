  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Demonstrates all streaming components: responses, thinking indicators, tool calls, code
      ...
      <div className="space-y-4">
            ...
            <CardContent className="pt-6">
              {msg.role === "user" ? (
                ...
                <div className="space-y-2">
                  ...
                  <MarkdownStreaming content={msg.content} isStreaming={false} />
                </div>
              )}
            </CardContent>
          </Card>
        ...
        {/* Tool calls */}
        {toolCalls.map((call) => (
          <ToolCallDisplay key={call.id} toolCall={call} defaultExpanded={true} />
        ))}
        ...
        {isStreaming && currentStream && (
          <Card>
            <CardContent className="pt-6">
              <p className="font-medium mb-2">AI Assistant</p>
              <MarkdownStreaming content={currentStream} isStreaming={true} showCursor={true} />
            </CardContent>
          </Card>
        )}
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <Input
          ...
          className="flex-1"
        />
        <Button type="submit" disabled={isStreaming || isThinking || !input.trim()}>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              <ThinkingIndicator message="Dots variant" variant="dots" />
              <ThinkingIndicator message="Spinner variant" variant="spinner" />
              <ThinkingIndicator message="Pulse variant" variant="pulse" />
            </div>
          </div>
        </CardContent>
      </Card>
