    ...
    return (
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button variant="ghost" size="icon" className="relative" aria-label="Select account">
          ...
          {accounts.map((account) => {
            ...
            return (
              ...
              >
                ...
                <div className={cn("size-2 rounded-full", getProviderColor(account.provider))} />
                ...
                {!allowMultiSelect && isSelected && <Check className="size-4 text-primary" />}
      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            {showUnreadCount && selectedAccount?.unreadCount && selectedAccount.unreadCount > 0 && (
              <Badge variant="secondary" className="text-xs">
