...
import type { CryptoCurrency, SubscriptionBillingHistory, SubscriptionPaymentProps } from "./types";
...
export function SubscriptionPayment({
  ...
  const [selectedPlanId, setSelectedPlanId] = useState(currentSubscription?.planId || plans[0]?.id);
  ...
  const getDaysUntilNextBilling = () => {
    ...
    return Math.ceil((currentSubscription.nextBillingDate - Date.now()) / (1000 * 60 * 60 * 24));
  };
      ...
      <CardHeader>
        <div className="flex items-start justify-between">
          <div>
            ...
            <CardDescription>Manage your recurring subscription payments</CardDescription>
          </div>
          {currentSubscription && (
          ...
          <div className="bg-secondary rounded-lg p-4 space-y-3">
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                <p className="text-2xl font-bold">${currentSubscription.plan.amount}</p>
            ...
            {currentSubscription.cancelAtPeriodEnd && (
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  ⚠️ Subscription will be cancelled at the end of the current billing period.
                </p>
              </div>
            )}
          </div>
          ...
          <>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>✓ Automatic renewal every {selectedPlan.interval}</li>
                <li>✓ First payment of ${selectedPlan.amount} will be charged immediately</li>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        onClick={() =>
                          window.open(`https://etherscan.io/tx/${bill.transactionHash}`, "_blank")
                        }
                      >
                        View →
                      </Button>
        ...
        {currentSubscription ? (
          <>
            {currentSubscription.status === "active" && (
              <>
                <Button variant="outline" className="flex-1" onClick={handlePauseSubscription}>
                  Pause Subscription
                </Button>
          ...
          <Button className="flex-1" onClick={handleSubscribe} disabled={isProcessing}>
            {isProcessing
              ? "Processing..."
              : `Subscribe - $${selectedPlan.amount}/${selectedPlan.interval}`}
          </Button>
        )}
      </CardFooter>
    </Card>
