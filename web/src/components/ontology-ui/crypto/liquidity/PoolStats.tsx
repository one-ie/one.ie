...
export function PoolStats({
  ...
  const getChartData = (history: ChartDataPoint[], type: string) => {
    ...
    return Array.from({ length: points }, (_, i) => ({
      ...
      value:
        type === "tvl"
          ? pool.tvl * (0.9 + Math.random() * 0.2)
          : type === "volume"
            ? pool.volume24h * (0.5 + Math.random() * 1.5)
            ...
            <div className="space-y-3">
              ...
              <div className="bg-muted/50 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Badge variant="secondary">
                    {formatCurrency(pool.reserve0 * pool.token0Price)}
                  </Badge>
                </div>
              ...
              <div className="bg-muted/50 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Badge variant="secondary">
                    {formatCurrency(pool.reserve1 * pool.token1Price)}
                  </Badge>
                </div>
                <div className="space-y-1 text-sm text-muted-foreground">
                  <div className="flex justify-between">
          ...
          <TabsContent value="performance" className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-lg font-semibold">{formatCurrency(pool.volumeWeek / 7)}</p>
              </div>
              <div className="space-y-2">
            ...
            <div className="text-xs text-muted-foreground bg-muted/30 p-3 rounded-lg">
              ...
              <p>
                APY is calculated based on current trading fees and reward distribution. Actual
                returns may vary based on market conditions and pool activity.
              </p>
            </div>
          </TabsContent>
        </Tabs>
