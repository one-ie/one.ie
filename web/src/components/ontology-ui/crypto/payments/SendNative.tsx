...
export function SendNative({
  ...
  const usdValue = amount ? (parseFloat(amount) * nativePrice).toFixed(2) : "0.00";

  const handleMaxClick = () => {
    const maxAmount = Math.max(0, parseFloat(balance) - parseFloat(gasReserve));
        ...
        <CardHeader className="pb-4">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <CardDescription className="mt-1">Send native currency instantly</CardDescription>
            </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min="0"
            />
            <div className="text-sm font-medium">≈ {formatCurrency(parseFloat(usdValue))}</div>
          </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-2 py-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium">{formatCurrency(parseFloat(usdValue))}</span>
            </div>
            <div className="flex items-center justify-between">
