...
export function RecurringPayment({
  ...
  const [payment, setPayment] = useState<PaymentService.RecurringPayment | null>(null);
  ...
  const handleCancel = async () => {
    ...
    try {
      const cancelled = await Effect.runPromise(PaymentService.cancelRecurringPayment(payment.id));
