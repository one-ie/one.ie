...
export function PaymentLink({
  ...
  const [generatedLink, setGeneratedLink] = useState<PaymentService.PaymentLink | null>(null);
              ...
              <div className="space-y-3 p-4 bg-secondary rounded-lg">
                ...
                {generatedLink.expiresAt && (
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline">{formatRelativeTime(generatedLink.expiresAt)}</Badge>
                  </div>
                )}
              </div>
      ...
      <CardFooter className="flex gap-2">
        {!generatedLink ? (
          ...
          <>
            ...
            {navigator.share && <Button onClick={handleShare}>Share Link</Button>}
          </>
        )}
      </CardFooter>
    </Card>
