...
export function InterestCalculator({
  ...
  useEffect(() => {
    ...
    const n = 365;
    const compound = principal * (1 + rate / n) ** (n * years) - principal;
  ...
  const apyCalc = (((1 + apr / 100 / 365) ** 365 - 1) * 100).toFixed(2);
            ...
            <TabsContent value="supply" className="space-y-4">
              ...
              <div className="bg-muted/50 p-4 rounded-lg">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Compound earns more by:</span>
        ...
        <CardContent className="space-y-4">
          ...
          <Alert>
            <AlertDescription className="text-sm">
              APY accounts for compound interest, which means your interest earns interest. This is
