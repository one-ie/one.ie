...
export function LendToken({ markets = [], tokens = [], userAddress, onLend }: LendTokenProps) {
          ...
          <>
            ...
            {parseFloat(amount) > 0 && (
              <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Receipt tokens automatically earn interest. They can be redeemed 1:1 for the
                  underlying asset plus accrued interest at any time.
                </p>
              </div>
            )}
            ...
            {parseFloat(amount) > 0 && (
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {((parseFloat(amount) / parseFloat(selectedMarket.totalSupply)) * 100).toFixed(
                      4
                    )}
                    %
                  </span>
