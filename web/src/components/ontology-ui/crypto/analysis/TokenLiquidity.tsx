      ...
      {showPriceImpact && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Calculate estimated price impact for your swap</CardDescription>
          </CardHeader>
          <CardContent>
...
function PriceImpactCalculator({ pools }: { pools: LiquidityPool[] }) {
  ...
  const impactColor =
    priceImpact < 1 ? "text-green-600" : priceImpact < 3 ? "text-yellow-600" : "text-red-600";
      ...
      {amount && selectedPool && (
        <div className="p-4 border rounded-lg bg-muted/50">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className={`text-lg font-bold ${impactColor}`}>{priceImpact.toFixed(3)}%</span>
          </div>
