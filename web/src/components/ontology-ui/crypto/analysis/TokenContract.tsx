  ...
  return (
    <div className={`space-y-4 ${className}`}>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="ghost" size="sm" onClick={() => copyToClipboard(contractAddress)}>
                  📋
                </Button>
          ...
          <TabsContent value="constructor">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Arguments used when deploying the contract</CardDescription>
              </CardHeader>
              <CardContent>
      ...
      {!contract.verified && (
        <Alert>
          <AlertDescription>
            This contract is not verified. The source code, ABI, and constructor arguments are not
            publicly available.
          </AlertDescription>
        </Alert>
      )}
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        />
        <InfoCard label="Source Available" value={contract.sourceCode ? "Yes" : "No"} />
      </div>
          ...
          {events.length > 0 && (
            <div>
              ...
              <div className="space-y-2">
                ...
                {events.length > 5 && (
                  <p className="text-sm text-muted-foreground">... and {events.length - 5} more</p>
                )}
              </div>
            </div>
          )}
