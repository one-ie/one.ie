...
import type { NFTBurnProps, NFTBurnReason } from "./types";
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-800 dark:text-red-200">
                Burning an NFT will permanently destroy it and remove it from your wallet. This
                action cannot be reversed. The NFT will be sent to a burn address (0x000...dEaD) and
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="flex-1"
              />
              <Button variant="outline" onClick={() => setAmount(nft.balance || "1")}>
                Max
              </Button>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <Label htmlFor="confirm" className="text-sm font-normal cursor-pointer leading-relaxed">
              I understand that burning this NFT will permanently destroy it and this action cannot
              be undone.
            </Label>
          </div>
          ...
          {requireConfirmation && confirmed && (
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) => setDoubleConfirmed(checked as boolean)}
              />
              <Label
                htmlFor="double-confirm"
                className="text-sm font-normal cursor-pointer leading-relaxed"
              >
                I have triple-checked and I am absolutely sure I want to burn this NFT.
              </Label>
            </div>
          )}
        </div>
