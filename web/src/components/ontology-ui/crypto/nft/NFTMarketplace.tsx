  ...
  return (
    <Card className={cn("max-w-2xl", className)}>
      <CardHeader>
        ...
        <CardDescription>List your NFT for sale or make an offer</CardDescription>
      </CardHeader>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {nft.collection?.floorPrice && (
                  <Badge variant="secondary">Floor: {nft.collection.floorPrice} ETH</Badge>
                )}
              </div>
            </div>
          </div>
      ...
      <CardContent>
        <Tabs defaultValue={mode}>
          ...
          <TabsContent value="list" className="space-y-4 mt-4">
            ...
            <Button onClick={handleList} disabled={!listPrice || isProcessing} className="w-full">
            ...
            {listings.length > 0 ? (
              <>
                {listings.map((listing) => (
                  <div key={listing.listingId} className="p-4 border rounded-lg space-y-3">
          ...
          <TabsContent value="offer" className="space-y-4 mt-4">
            <div className="space-y-2">
              ...
              {nft?.collection?.floorPrice && offerPrice && (
                <div className="text-sm text-muted-foreground">
                  {((parseFloat(offerPrice) / parseFloat(nft.collection.floorPrice)) * 100).toFixed(
                    0
                  )}
                  % of floor price
                </div>
                ...
                {offers.map((offer) => (
                  <div key={offer.offerId} className="p-4 border rounded-lg space-y-3">
                    <div className="flex justify-between items-start">
                      ...
                      <Badge variant={offer.expiresAt > Date.now() ? "default" : "secondary"}>
