...
import type { ChatInvoiceProps, InvoiceLineItem, InvoiceState, Token } from "./types";
    ...
    return (
      ...
      >
        <CardHeader className="pb-4">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <CardDescription className="mt-1 font-mono">{invoice.invoiceNumber}</CardDescription>
            </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span>
                {invoice.subtotal} {invoice.token}
              </span>
            </div>
          ...
          {invoice.dueDate && (
            <Alert>
              <AlertDescription>Due: {formatDate(invoice.dueDate)}</AlertDescription>
            </Alert>
          )}
        ...
        <CardFooter className="flex gap-2">
          {invoice.status === "pending" && <Button className="flex-1">Pay Invoice</Button>}
  ...
  return (
    ...
    >
      <CardHeader className="pb-4">
        ...
        <CardDescription className="mt-1">Send a professional invoice in chat</CardDescription>
      </CardHeader>
