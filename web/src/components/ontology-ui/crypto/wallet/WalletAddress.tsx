...
export function WalletAddress({
  ...
  const displayAddress = shouldTruncate ? truncate(address, length) : address;
        ...
        <div className="flex items-center gap-3">
          <Avatar>
            {ensAvatar ? (
              ...
              <AvatarFallback className={cn(generateIdenticon(address), "text-white")}>
          ...
          <div className="flex-1 min-w-0">
            {ensName && <div className="font-medium text-sm mb-1">{ensName}</div>}
            <TooltipProvider>
              <Tooltip>
