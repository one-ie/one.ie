  ...
  return (
    ...
    >
      <CardHeader className="pb-3">
        ...
        <CardDescription>Securely export your wallet credentials</CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription className="text-xs mt-2">
            Never share your private key or seed phrase with anyone. Anyone with access to these can
            steal all your funds. Store them securely offline.
          </AlertDescription>
        </Alert>
        ...
        {requirePassword && !isVerified && (
          <div className="space-y-3">
            ...
            <Button variant="outline" className="w-full" onClick={handleVerifyPassword}>
              Verify Password
            </Button>
          </div>
        )}
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-3 gap-2 p-3 bg-destructive/10 rounded border border-destructive/30">
                    {[
                      ...
                      <div key={i} className="text-xs font-mono bg-background px-2 py-1 rounded">
                        {i + 1}. {word}
                      </div>
                    ))}
                  </div>
        ...
        <div className="w-full">
          <Alert>
            <AlertDescription className="text-xs">
              <strong>Best Practices:</strong> Write down your seed phrase on paper and store it in
              a secure location. Never store it digitally or take screenshots.
            </AlertDescription>
          </Alert>
        </div>
      </CardFooter>
