...
import { File, FileText, Image as ImageIcon, Upload, Video, X } from "lucide-react";
            ...
            {files.map((uploadedFile) => (
              <div key={uploadedFile.id} className="flex items-center gap-3 p-3 border rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-medium truncate">{uploadedFile.file.name}</div>
                  <div className="text-xs text-muted-foreground">
                  ...
                  {uploadedFile.status === "error" && (
                    <div className="text-xs text-destructive mt-1">{uploadedFile.error}</div>
                  )}
                </div>
