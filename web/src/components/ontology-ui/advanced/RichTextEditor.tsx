    ...
    <Card className={cn("w-full", className)}>
      {showToolbar && (
        <CardHeader className="pb-3">
          <div className="flex flex-wrap gap-1">
            ...
            <Separator orientation="vertical" className="h-8" />
            <Button type="button" variant="ghost" size="sm" onClick={formatLink} title="Link">
              <LinkIcon className="h-4 w-4" />
            </Button>
            <Button type="button" variant="ghost" size="sm" onClick={formatImage} title="Image">
      ...
      <CardContent className="relative">
        ...
        <div className="mt-2 text-xs text-muted-foreground">
          <details>
            <summary className="cursor-pointer hover:text-foreground">Markdown Guide</summary>
