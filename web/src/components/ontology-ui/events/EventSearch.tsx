...
import { cn, formatRelativeTime, getEventTypeDisplay, groupBy } from "../utils";
...
export function EventSearch({
  ...
  const groupedEvents = groupByType ? groupBy(filteredEvents, "type") : { all: filteredEvents };
              ...
              >
                <div className="flex-1 space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="font-medium">{getEventTypeDisplay(event.type)}</span>
