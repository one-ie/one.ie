...
import type { Dimension, FilterConfig, SortConfig } from "../types";
          ...
          <TableHeader>
            <TableRow>
              {columns.map((column) => (
                <TableHead
                  key={column}
                  className={cn("cursor-pointer hover:bg-muted/50 select-none", compact && "py-2")}
          ...
          <TableBody>
            {displayItems.length === 0 ? (
              ...
              displayItems.map((item, index) => (
                ...
                >
                  {columns.map((column) => (
                    <TableCell key={column} className={cn(compact && "py-2")}>
