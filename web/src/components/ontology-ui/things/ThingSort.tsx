...
export function ThingSort({ value, onChange, className }: ThingSortProps) {
  ...
  const DirectionIcon = !value ? ArrowUpDown : value.direction === "asc" ? ArrowUp : ArrowDown;

  const directionLabel = !value ? "Sort" : value.direction === "asc" ? "Ascending" : "Descending";
