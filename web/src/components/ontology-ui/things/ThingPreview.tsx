...
import { formatDateTime, getThingTypeDisplay, getThingTypeIcon } from "../utils";
...
export function ThingPreview({ thing, open, onOpenChange, onEdit, onDelete }: ThingPreviewProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          {thing.description && (
            <DialogDescription className="text-base">{thing.description}</DialogDescription>
          )}
        </DialogHeader>
