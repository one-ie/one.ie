...
import type { FormProps, Thing } from "../types";
...
export function ThingEditor({ thing, onSave, onCancel, className }: ThingEditorProps) {
          ...
          <Tabs defaultValue="details" className="w-full">
            ...
            <TabsContent value="settings" className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-mono text-muted-foreground">{thing._id}</p>
              </div>

              <div className="space-y-2">
                <Label>Group ID</Label>
                <p className="text-sm font-mono text-muted-foreground">{thing.groupId}</p>
              </div>

              <div className="space-y-2">
                <Label>Owner ID</Label>
                <p className="text-sm font-mono text-muted-foreground">{thing.ownerId}</p>
              </div>
            </TabsContent>
          </Tabs>
        </form>
