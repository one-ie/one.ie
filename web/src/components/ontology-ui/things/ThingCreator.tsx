...
import type { FormProps, Thing, ThingType } from "../types";
import { cn, getThingTypeDisplay, getThingTypeIcon } from "../utils";
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                {getThingTypeDisplay(formData.type).toLowerCase()}
              </p>
            </div>
        ...
        {currentStep === "review" && formData.type && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Review your thing before creating it</p>
            </div>
