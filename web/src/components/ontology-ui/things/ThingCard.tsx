...
import type { CardProps, Thing, ThingType } from "../types";
import { cn, formatDate, getThingTypeColor, getThingTypeDisplay, getThingTypeIcon } from "../utils";
            ...
            <div className="flex-1 min-w-0">
              ...
              {showType && (
                <Badge
                  ...
                  className={cn(
                    "mt-1",
                    `bg-${typeColor}-100 text-${typeColor}-800 dark:bg-${typeColor}-900 dark:text-${typeColor}-100`
                  )}
                >
                  {typeDisplay}
                </Badge>
