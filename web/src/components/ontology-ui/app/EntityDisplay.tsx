...
import type { Connection, Dimension, Event, Person, Thing } from "../types";
        ...
        <ScrollArea className="flex-1">
          <div className="p-6">
            <TabsContent value="details" className="mt-0 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-3">
                  {"type" in entity && <DetailRow label="Type" value={entity.type} />}
            ...
            <TabsContent value="related" className="mt-0 space-y-4">
              {relatedEntities.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">No related entities</div>
              ) : (
