    ...
    <div className={className}>
      <div className="mb-6">
        ...
        {searchQuery && (
          <p className="mt-2 text-sm text-muted-foreground">
            Found {filteredPosts.length} {filteredPosts.length === 1 ? "update" : "updates"}
          </p>
        )}
      </div>
      ...
      {filteredPosts.length === 0 && searchQuery ? (
        <div className="text-center py-12">
          <p className="text-lg text-muted-foreground">No updates found matching "{searchQuery}"</p>
        ...
        >
          {filteredPosts.map((entry) => (
            ...
            >
              ...
              >
                {entry.data.image && viewMode === "list" && !brokenImages.has(entry.slug) && (
                ...
                {entry.data.image && viewMode === "grid" && !brokenImages.has(entry.slug) && (
