...
export function FreeShippingProgress({ threshold = 50 }: FreeShippingProgressProps) {
      ...
      {isEligible ? (
        ...
        <>
          <p className="text-sm text-muted-foreground mb-3">
            Add <span className="font-semibold text-foreground">${remaining.toFixed(2)}</span> more
            for free shipping!
          </p>
