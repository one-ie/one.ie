						...
						<div className="space-y-4">
							...
							<div>
								...
								<p className="text-sm text-muted-foreground">
									Paste the prompt you copied into Claude Code's chat. It will
									set up the project scaffolding and help you build it
									step-by-step.
								</p>
							</div>
							...
							<div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
								<p className="text-sm text-blue-900 dark:text-blue-100">
									<strong>What's Next:</strong> Claude Code will guide you
									through building the project with real-time code suggestions,
