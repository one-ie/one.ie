    ...
    <section className="px-4 py-20 sm:px-6 sm:py-24 md:px-8 md:py-32 bg-muted/30">
      <div className="mx-auto max-w-full sm:max-w-6xl">
        <div className="mb-12 space-y-4 text-center">
          <div
            className="rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground mb-2 inline-flex items-center gap-2"
          >
            <svg
