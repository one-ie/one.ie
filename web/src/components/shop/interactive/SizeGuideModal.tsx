								...
								<div className="space-y-3 text-sm text-muted-foreground">
									<div>
										...
										<p>
											...
											tape measure horizontal and comfortable.
										</p>
									</div>
									<div>
										<h4 className="font-medium text-foreground mb-1">
									...
									<div>
										...
										<p>
											...
											approximately 8 inches below your waist.
										</p>
									</div>
									<div>
										<h4 className="font-medium text-foreground mb-1">
										...
										<p>
											Measure from the highest point of your shoulder to your
								...
								<div className="flex gap-2">
									...
									<div className="text-sm">
										...
										<p className="text-blue-800 dark:text-blue-200">
											For best results, ask someone to help you take
											measurements. Wear fitted clothing or undergarments and
						...
						<div className="space-y-3">
							<div className="rounded-lg border p-4">
								...
								<p className="text-sm text-muted-foreground">
									Comfortable, classic cut with room to move. Not too tight or
									loose. Perfect for everyday wear.
								</p>
							</div>
							...
							<div className="rounded-lg border p-4">
								...
								<p className="text-sm text-muted-foreground">
									Tailored closer to the body for a modern, streamlined look.
									More fitted through chest and waist.
								</p>
							</div>
							...
							<div className="rounded-lg border p-4">
								...
								<p className="text-sm text-muted-foreground">
									Looser, more comfortable fit with extra room throughout. Ideal
									for casual, laid-back style.
								</p>
							</div>
							...
							<div className="rounded-lg bg-muted p-4">
								...
								<p className="text-sm text-muted-foreground">
									...
									comfortable fit, or sizing down if you prefer a tighter fit.
