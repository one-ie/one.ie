  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-32 border-t-4 border-black dark:border-white">
      <div className="text-center mb-24">
        <p className="text-xs font-bold tracking-[0.3em] uppercase mb-3">Why Choose Us</p>
        <h2 className="text-5xl md:text-6xl font-light tracking-tight">Premium Service</h2>
      </div>
        ...
        {values.map((value, index) => (
          <div key={index} className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xs font-bold tracking-[0.3em] uppercase">{value.title}</p>
            </div>
