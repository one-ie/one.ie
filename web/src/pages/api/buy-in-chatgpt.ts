					...
					choices: [
						{
							message: {
								content:
									"I'm currently in demo mode. To enable AI responses, please add your OpenRouter API key to the .env file as OPENROUTER_API_KEY or PUBLIC_OPENROUTER_API_KEY.",
							},
						},
					],
				}),
