 ...
 *
 * Uses existing product data from shop/buy-in-chatgpt.astro
 */

import type { APIRoute } from "astro";

// Product data structure (matches buy-in-chatgpt.astro)
interface Product {
	id: string;
	title: string;
	category: string;
...
// Product catalog (synced with buy-in-chatgpt.astro)
...
function transformToACPFormat(product: Product, baseUrl: string): ACPProduct {
	return {
		...
		link: `${baseUrl}/shop/buy-in-chatgpt`,
