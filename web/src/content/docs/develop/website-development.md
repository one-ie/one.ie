...
description: Build performant frontend applications using Astro 5, React 19, and the 6-dimension ontology. Learn progressive complexity architecture and pattern convergence.
section: Develop
order: 1
tags:
  - frontend
...
You've read the root README. Now learn how to **build the frontend** that renders the 6-dimension ontology.
