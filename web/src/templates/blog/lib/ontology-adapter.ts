 ...
 */
export function blogPostToThing(
	entity: BlogPost,
	groupId: Id<"groups">,
): CreateThingInput {
 ...
 */
export function blogCategoryToThing(
	entity: BlogCategory,
	groupId: Id<"groups">,
): CreateThingInput {
