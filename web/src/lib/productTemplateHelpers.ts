 ...
 */
export function getProductFeatures(product: Product): Array<{ title: string; description: string; image: string }> {
  const categoryFeatures: Record<string, Array<{ title: string; description: string }>> = {
    'fragrances': [
      {
        title: 'Iconic Bottle Design',
        description: 'The sleek, minimalist bottle embodies pure sophistication. Every curve and edge is meticulously crafted. A statement piece for your vanity that exudes luxury and elegance.'
      },
      {
        title: 'Long-Lasting Formula',
        description: 'Experience a fragrance that evolves throughout the day. Premium Eau de Parfum concentration ensures 8-10 hours of rich, complex scent that lingers with intention and depth.'
      },
      {
        title: 'Luxury Presentation',
        description: 'Arrives in premium packaging with gift box included. Every detail speaks to craftsmanship and heritage. Perfect for gifting or adding to your personal collection.'
      },
    ],
    'smartphones': [
      {
        title: 'Cutting-Edge Performance',
        description: 'Powered by the latest processor technology for seamless multitasking. Experience lightning-fast speeds and smooth performance for all your apps and games.'
      },
      {
        title: 'Stunning Display',
        description: 'Immerse yourself in vibrant colors and crystal-clear resolution. Advanced display technology brings your content to life with incredible detail and brightness.'
      },
      {
        title: 'Professional Camera',
        description: 'Capture stunning photos and videos in any lighting condition. Advanced camera system with multiple lenses for professional-quality results every time.'
      },
    ],
    'default': [
      {
      ...
      },
      {
        ...
        description: 'Get more for your money with features typically found in higher-priced alternatives. Quality and affordability combined in one outstanding product.'
      },
      {
        title: 'Reliable Performance',
        description: 'Built to last and perform consistently day after day. Backed by our warranty and commitment to customer satisfaction for complete peace of mind.'
      },
    ],
  };
 ...
 */
export function generateReviews(product: Product): Array<{ author: string; rating: number; text: string; date: string }> {
