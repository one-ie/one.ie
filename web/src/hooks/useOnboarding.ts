...
export function useSignupOnboarding() {
	...
	const mutate = useCallback(
		async (input: SignupInput): Promise<SignupResponse | null> => {
			setLoading(true);
			setError(null);
...
export function useVerifyEmailOnboarding() {
	...
	const mutate = useCallback(
		async (input: VerifyEmailInput): Promise<boolean> => {
			setLoading(true);
			setError(null);
...
export function useResendVerificationCode() {
	...
	const mutate = useCallback(
		async (input: ResendCodeInput): Promise<boolean> => {
			setLoading(true);
			setError(null);

			try {
				const result = await client.mutation(
					"mutations:auth:resendVerificationCode",
					input,
				);
...
export function useInviteTeamMember() {
	...
	const invite = useCallback(
		async (input: InviteTeamMemberInput): Promise<boolean> => {
			setLoading(true);
			setError(null);
...
export function useConnectWallet() {
	...
	const connect = useCallback(
		async (input: ConnectWalletInput): Promise<boolean> => {
			setLoading(true);
			setError(null);
...
export function useCheckWorkspaceSlugAvailable() {
	...
	const check = useCallback(async (slug: string): Promise<boolean> => {
		...
		try {
			const result = await client.query(
				"queries:onboarding:checkWorkspaceSlugAvailable",
				{ slug },
			);
			return result.available ?? false;
		} catch {
